        ...
        ${theme === 'dark' ? 'bg-[#1d2b3a]' : 'bg-[#ffffff]'}`}>
            <div className='w-full flex gap-3 p-2'>
                <div className='flex flex-col w-[70%]'>
                    {/* Header */}
                    <div className={`flex relative rounded-2xl  ${theme === 'dark' ? 'bg-[#2f3f50]' : 'bg-[#e7edfd]'} flex-col  mb-6 gap-3 p-8`}>
